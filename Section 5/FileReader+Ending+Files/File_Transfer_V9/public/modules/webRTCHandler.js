...
export async function createAndSendOffer() {
    ...
    // step 5. Blast off 🚀 Finally, send your offer to the other peer
...
function registerDataChannelEventListeners(dataChannel) {
    ...
    dataChannel.addEventListener("close", (e) => {
        ...
        // close our peer connection gracefully
    ...
    dataChannel.addEventListener("bufferedamountlow", () => {
        console.log("⌛⌛⌛⌚⌚ Buffered amount is low, you can send more data now unless of course, this is the final message and no more data needs to be sent");
    }); 
...
export function closeDataChannel(dataChannel) {
    dataChannel.close();
    uiUtils.logToCustomConsole(`Closing data channel: ${dataChannel.label}`, constants.myColors.orange);
};
